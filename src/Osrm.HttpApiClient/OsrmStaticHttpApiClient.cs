...
namespace Osrm.HttpApiClient
{
    public static class OsrmStaticHttpApiClient
    {
        ...
        public static Task<NearestResponse> GetNearestAsync(
            ...
            => MakeRequestAsync<NearestRequest, NearestResponse>(
                baseAddress,
                httpClient,
                request,
        ...
        public static Task<RouteResponse<TGeometry>> GetRouteAsync<TGeometry>(
            ...
            => MakeRequestAsync<RouteRequest<TGeometry>, RouteResponse<TGeometry>>(
                baseAddress,
                httpClient,
                request,
                jsonSerializerOptions,
        ...
        public static Task<TableResponse> GetTableAsync(
            ...
            JsonSerializerOptions? jsonSerializerOptions = null,
            CancellationToken cancellationToken = default)
            => MakeRequestAsync<TableRequest, TableResponse>(
                baseAddress,
                httpClient,
                request,
                jsonSerializerOptions,
        ...
        public static Task<MatchResponse<TGeometry>> GetMatchAsync<TGeometry>(
            ...
            CancellationToken cancellationToken = default)
            where TGeometry : Geometry
            => MakeRequestAsync<MatchRequest<TGeometry>, MatchResponse<TGeometry>>(
                baseAddress,
                httpClient,
                request,
                jsonSerializerOptions,
        ...
        public static Task<TripResponse<TGeometry>> GetTripAsync<TGeometry>(
            ...
            CancellationToken cancellationToken = default)
            where TGeometry : Geometry
            => MakeRequestAsync<TripRequest<TGeometry>, TripResponse<TGeometry>>(
                baseAddress,
                httpClient,
                request,
                jsonSerializerOptions,
        ...
        public static async Task<TileResponse> GetTileAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var requestUri = BuildRequestUri(baseAddress, request);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static string BuildRequestUri<TRequest>(string? baseAddress, TRequest request)
